        ...
        <div class="shopcart">
            <div class="content" @click="toggleList">
                ...
                <transition name="fold">
                    <div class="shopcart-list" v-show="listShow" @click.stop.prevent='donothing'>
                            ...
                            <ul>
                                <li class="food" v-for="(food,index) in selectFoods" :key="index">
                                    ...
                                    <div class="cart-control-wrapper">
                                        <carControl :food="food" @add="foodAdd"></carControl>
                                    </div>
                                </li>
                            </ul>
                        </div>
        ...
        .content
            ...
            .ball-wrapper
                .ball
                    ...
                    left 32px
                    bottom 22px
                    transition all 0.4s cubic-bezier(.49,-0.52,.83,.67)
                    .inner
                        width 16px
                        height 16px
                        border-radius 50%
